...
const chopShop = {
    ...
    calcTotalPrice(stoneName) {
        const findElement = this.stones.find((stone) => stone.name === stoneName);
        if (!findElement) return `Введите коректное название драгоценного камня вместо ${stoneName}`;
...
console.log(chopShop.calcTotalPrice('Ruby1')); // 1600
